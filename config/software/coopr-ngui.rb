...
build do
  ...
  command "cd #{project_dir}/ngui; #{node} #{project_dir}/ngui/node_modules/bower/bin/bower install --config.interactive=false"
  command "cd #{project_dir}/ngui; #{node} #{project_dir}/ngui/node_modules/gulp/bin/gulp.js build minify"
